    ...
    <div class="cmfwc_main_wrap">
          <div class='global_options_group'>
            <div id="setting_title">
                <h3 class="global-options"><?php esc_html_e( 'Global Options', 'custom-meta-for-woocommerce' ); ?></h3>
            </div>
                    ...
                    if (!empty($custom_fields)) {
                        ...
                        ?>
                         <div class="field-wrapper">
                            ...
                            <label for="icon_title"><?php esc_html_e('Title','custom-meta-for-woocommerce');?></label>
            ...
            <div class="category_based_cmfw_section">
                <label for="cmfw_category_based_hide_price"> <?php echo esc_html_e('Display custom fields on Category Based ','custom-meta-for-woocommerce');?> </label>
            ...
            <!---Style area start --->
                    <div id="cmfwc_style_area_wrap">
                            <h3><?php echo esc_html_e('Style Area', 'custom-meta-for-woocommerce'); ?></h3>

                        <div class="cmfwc_img_size_setup">
                            <div class="img_height">
                                <label for="cmfwc_img_height"> <?php echo esc_html_e('Image Height', 'custom-meta-for-woocommerce'); ?></label>
                                <input type="number" name="cmfwc_img_height" id="cmfwc_img_height" value="<?php echo esc_attr($cmfwc_img_height);?>">
                            </div>
                            <div class="img_width">
                                <label for="cmfwc_img_height"> <?php echo esc_html_e('Image Width', 'custom-meta-for-woocommerce'); ?></label>
                        ...
                        <div class="cmfwc_font_size_setup">
                            <label for="cmfwc_font_size"> <?php echo esc_html_e('Font Size', 'custom-meta-for-woocommerce'); ?></label>
                        ...
                        <div class="cmfwc_bg_color_setup">
                            <label for="cmfwc_style_area_color"> <?php echo esc_html_e('Background Color', 'custom-meta-for-woocommerce'); ?></label>
                        ...
                        <div class="cmfwc_font_color_setup">
                            <label for="cmfwc_font_color"> <?php echo esc_html_e('Font Color', 'custom-meta-for-woocommerce'); ?></label>
                            <input name="cmfwc_font_color"  id="cmfwc_font_color" value="<?php echo esc_attr($cmfwc_font_color);?>">
                        </div>

                        <div class="cmfwc_margin_setup">
                            <label for="cmfwc_margin"> <?php echo esc_html_e('Set Margin', 'custom-meta-for-woocommerce'); ?></label>
                            <input type="number" name="cmfwc_margin" id="cmfwc_margin" value="<?php echo esc_attr($cmfwc_margin);?>">
                        </div>

                        <div class="cmfwc_padding_setup">
                            <label for="cmfwc_padding"> <?php echo esc_html_e('Set Padding', 'custom-meta-for-woocommerce'); ?></label>
                        ...
                        <div class="cmfwc_border_radius_setup">
                            <label for="cmfwc_border_radius"> <?php echo esc_html_e('Set Border Radius', 'custom-meta-for-woocommerce'); ?></label>
            ...
            <!---Icon Style area --->
                    <div id="cmfwc_icon_style_area_wrap">
                                <h3><?php echo esc_html_e('Icon Design', 'custom-meta-for-woocommerce'); ?></h3>
                        <div class="icon_setup">
                            <div class="icon_size">
                                <label for="cmfwc_icon_size"> <?php echo esc_html_e('Icon Font Size', 'custom-meta-for-woocommerce'); ?></label>
                                <input type="number" name="cmfwc_icon_size" id="cmfwc_icon_size" value="<?php echo esc_attr($cmfwc_icon_size);?>">
                            </div>

                            <div class="icon_color">
                                <label for="cmfwc_icon_color"> <?php echo esc_html_e('Icon Font Color', 'custom-meta-for-woocommerce'); ?></label>
                                <input type="text" name="cmfwc_icon_color" id="cmfwc_icon_color" value="<?php echo esc_attr($cmfwc_icon_color);?>">
                            </div>

                            <div class="icon_margin">
                                <label for="cmfwc_icon_margin"> <?php echo esc_html_e('Icon Margin', 'custom-meta-for-woocommerce'); ?></label>
                            ...
                            <div class="icon_padding">
                                <label for="cmfwc_icon_padding"> <?php echo esc_html_e('Icon Padding', 'custom-meta-for-woocommerce'); ?></label>
            ...
            <button type="button" id="save_change" class="button"><?php esc_html_e('Save Change', 'custom-meta-for-woocommerce'); ?></button>
