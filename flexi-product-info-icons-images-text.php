<?php
/**
 * Plugin Name:       FlexiProduct Info – Icons, Images & Text
 * Description:       FlexiProduct Info: Add icons, images & custom text to product pages. Boost WooCommerce conversions with enhanced product information display.
 * Version:           1.0.0
 * Author:            codersaleh
 ...
 * Text Domain:       flexi-product-info-icons-images-text
...
function cmfw_plugin_instance() {
	...
	if ( in_array( 'flexi-product-info-icons-images-text/flexi-product-info-icons-images-text.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
